        ...
        <Grid item xs={12} sm={8}>
          <Paper>
            <Box p={4} style={{ textAlign: 'center' }}>
              <h2>SHIELD FINANCE</h2>
              <p>
                $SHIELD is an algorithmic token pegged to AVAX
              </p>
              <p>
        ...
        <Grid item xs={12} sm={4}>
          <Card>
            <CardContent align="center" style={{ position: 'relative' }}>
              ...
              <h2 style={{ marginBottom: '10px' }}>SHIELD</h2>
        ...
        <Grid item xs={12} sm={4}>
          <Card>
            <CardContent align="center" style={{ position: 'relative' }}>
              ...
              <Box>
                <span style={{ fontSize: '16px' }}>$???? / SSHARE</span>
              </Box>
              <span style={{ fontSize: '12px' }}>
                Market Cap: $????
                <br />
        ...
        <Grid item xs={12} sm={4}>
          <Card>
            <CardContent align="center" style={{ position: 'relative' }}>
              ...
              <Box>
                <span style={{ fontSize: '16px' }}>$???? / SBOND</span>
              </Box>
              <span style={{ fontSize: '12px' }}>
                Market Cap: $????<br />
                Circulating Supply: ????<br />
